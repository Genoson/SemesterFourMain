...
public class Time {
    ...
    /** Brandon Follett wrote the following lovely range constraints
     * hour = ((0 <= hour) && (hour <= 23) ? hour : 0);
     * minute = ((0 <= minute) && (minute <= 59) ? minute : 0);
     * second = ((0 <= second) && (second <= 59) ? second : 0);
     * ^^ use of the above ternary operators is more elegant but perhaps not as readable
     * ^^ functionalizing the above code could help with readability
     */
