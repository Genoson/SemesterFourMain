...
public class Bonus {
    ...
    public static void main(String[] args) {
        ...
        switch (dept)   {
            ...
            case 3:
                ...
                // I love the use of the ternary operator!
    ...
    public static double getBonus(double sales) {
        if (sales >= SALES_BONUS) {
            double bonus = SALES_BONUS_RATE * (sales);
            return bonus;
        } else {
            return 0;
        }
    ...
    public static double getBonus(int numUnits) {
        if (numUnits >= SALES_UNIT_BONUS) {
            double bonus = numUnits * (SALES_UNIT_REG + SALES_UNIT_EXTRA);
            return bonus;
        } else {
    ...
    public static double getBonus(int numUnits, int bonusLimit) {
        if (numUnits >= bonusLimit) {
            double bonus = numUnits * (PARTS_BONUS);
            return bonus;
        } else {
            double bonus = 0;
            return bonus;
